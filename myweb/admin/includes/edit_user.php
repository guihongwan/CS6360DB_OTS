...
if(isset($_POST['edit_user'])){
    ...
    $user_password_new    = mysqli_real_escape_string($connection,$user_password_new);
    
    if( $user_password != $user_password_new ){
        $user_password = $user_password_new;
        $user_password_en = crypt($user_password_new, $salt);
    }else{
        $user_password_en = $user_password_new;
    }
    ...
    $query .="user_password = '$user_password_en' ";
